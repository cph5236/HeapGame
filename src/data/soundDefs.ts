...
export const SOUND_DEFS: Record<string, SoundDef> = {
  ...
  'player-jump':           { category: 'playerSfx', loop: false, baseVolume: 0.9, url: playerJumpUrl },
  'player-land':           { category: 'playerSfx', loop: false, baseVolume: 0.0, url: playerLandUrl },
  'player-die':            { category: 'playerSfx', loop: false, baseVolume: 1.0, url: playerDieUrl },
  'player-dash':           { category: 'playerSfx', loop: false, baseVolume: 0.9, url: playerDashUrl },
  'enemy-kill':            { category: 'enemySfx',  loop: false, baseVolume: 0.9, url: enemyKillUrl },
