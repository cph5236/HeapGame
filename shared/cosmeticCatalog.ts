...
export const COSMETIC_CATALOG: readonly CatalogEntry[] = [
  ...
  { id: 'face_wonkyeyes',    slot: 'face' },
  { id: 'face_lazyeye',      slot: 'face' },
  { id: 'face_walleyes',     slot: 'face' },
  { id: 'face_3dstripes',    slot: 'face' },
  { id: 'face_clearglasses', slot: 'face' },
  { id: 'face_shutter',      slot: 'face' },
  { id: 'face_shutterred',   slot: 'face' },
  { id: 'face_shutterblue',  slot: 'face' },
  { id: 'face_shuttergreen', slot: 'face' },
  { id: 'face_shutterorange',slot: 'face' },
  { id: 'face_shutterpink',  slot: 'face' },
  // ── Trail (8) ──
