...
ALTER TABLE heap ADD COLUMN positive_item_spawn_rate REAL NOT NULL DEFAULT 0.15;
ALTER TABLE heap ADD COLUMN negative_item_spawn_rate REAL NOT NULL DEFAULT 0.85;
